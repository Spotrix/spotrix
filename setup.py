...
PACKAGE_JSON = os.path.join(BASE_DIR, "spotrix-frontend", "package.json")
...
VERSION_INFO_FILE = os.path.join(BASE_DIR, "spotrix", "static", "version_info.json")
...
setup(
    ...
    zip_safe=False,
    entry_points={"console_scripts": ["spotrix=spotrix.cli:spotrix"]},
    install_requires=[
        "backoff>=1.8.0",
        "bleach>=3.0.2, <4.0.0",
        "cachelib>=0.1.1,<0.2",
        ...
        "sqlalchemy-utils>=0.36.6,<0.38.0",
