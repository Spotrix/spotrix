...
from spotrix import app, db, security_manager
from spotrix.exceptions import CertificateException, SpotrixException
from spotrix.models.core import Database, Log
...
from spotrix.utils import schema
...
class TestUtils(SupersetTestCase):
    ...
    def test_validate_json(self):
        ...
        with self.assertRaises(SpotrixException):
    ...
    def test_log_this(self) -> None:
        ...
        resp = self.get_json_resp(
            f"/spotrix/explore_json/{slc.datasource_type}/{slc.datasource_id}/"
