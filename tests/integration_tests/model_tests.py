...
from spotrix import app, db as metadata_db
...
from spotrix.utils.core import get_example_database, QueryStatus
...
class TestDatabaseModel(SupersetTestCase):
    ...
    @mock.patch("spotrix.models.core.create_engine")
    ...
    def test_get_sqla_engine(self, mocked_create_engine):
        ...
        model.db_engine_spec.get_dbapi_exception_mapping = mock.Mock(
            return_value={Exception: SpotrixException}
        )
