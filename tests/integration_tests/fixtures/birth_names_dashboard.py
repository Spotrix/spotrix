...
def _load_data():
    ...
    with app.app_context():
        ...
        from spotrix.examples.birth_names import create_slices, create_dashboard
...
def _create_table(
    ...
    from spotrix.examples.birth_names import _add_table_metrics, _set_table_metadata
