...
def _create_world_bank_slices(table: SqlaTable) -> List[Slice]:
    from spotrix.examples.world_bank import create_slices
...
def _create_world_bank_dashboard(table: SqlaTable, slices: List[Slice]) -> Dashboard:
    from spotrix.examples.world_bank import dashboard_positions

    pos = dashboard_positions
    from spotrix.examples.helpers import update_slice_ids
