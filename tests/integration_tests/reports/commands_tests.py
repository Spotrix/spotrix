...
from spotrix.reports.commands.execute import AsyncExecuteReportScheduleCommand
from spotrix.reports.commands.log_prune import AsyncPruneReportScheduleLogCommand
...
def test_soft_timeout_alert(email_mock, create_alert_email_chart):
    ...
    from spotrix.reports.commands.exceptions import AlertQueryTimeout
