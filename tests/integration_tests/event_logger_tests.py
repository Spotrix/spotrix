...
class TestEventLogger(unittest.TestCase):
    ...
    def test_log_this(self, mock_log):
        ...
        with app.test_request_context("/spotrix/dashboard/1/?myparam=foo"):
            result = test_func()
            ...
            self.assertEqual(
                ...
                [
                    {
                        "myparam": "foo",
                        "path": "/spotrix/dashboard/1/",
                        "url_rule": "/spotrix/dashboard/<dashboard_id_or_slug>/",
