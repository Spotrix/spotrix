...
from spotrix.result_set import dedup, SpotrixResultSet

from .base_tests import SupersetTestCase


class TestSpotrixResultSet(SupersetTestCase):
    def test_dedup(self):
    ...
    def test_get_columns_basic(self):
        ...
        results = SpotrixResultSet(data, cursor_descr, BaseEngineSpec)
        self.assertEqual(
            results.columns,
            [
