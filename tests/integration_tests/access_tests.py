...
from spotrix.connectors.druid.models import DruidDatasource
...
EXTEND_ROLE_REQUEST = (
    "/spotrix/approve?datasource_type={}&datasource_id={}&"
...
class TestRequestAccess(SupersetTestCase):
    ...
    def test_override_role_permissions_is_admin_only(self):
        ...
        response = self.client.post(
            "/spotrix/override_role_permissions/",
    ...
    def test_request_access(self):
        if app.config["ENABLE_ACCESS_REQUEST"]:
            ...
            ROLE_GRANT_LINK = (
                '<a href="/spotrix/approve?datasource_type={}&datasource_id={}&'
