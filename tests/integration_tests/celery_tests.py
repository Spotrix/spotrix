...
from spotrix import db, sql_lab
...
from spotrix.models.helpers import QueryStatus
from spotrix.models.sql_lab import Query
from spotrix.sql_parse import ParsedQuery, CtasMethod
from spotrix.utils.core import get_example_database, backend
...
def test_default_data_serialization():
    ...
    results = SpotrixResultSet(SERIALIZATION_DATA, CURSOR_DESCR, db_engine_spec)
