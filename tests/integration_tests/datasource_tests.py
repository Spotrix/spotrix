...
from spotrix import app, ConnectorRegistry, db
...
from spotrix.exceptions import SpotrixGenericDBErrorException
...
class TestDatasource(SupersetTestCase):
    ...
    def test_external_metadata_error_return_400(self, mock_get_datasource):
        ...
        mock_get_datasource.side_effect = SpotrixGenericDBErrorException("oops")
