...
class TestDashboard(SupersetTestCase):
    ...
    def test_save_dash(self, username="admin"):
        ...
        url = "/spotrix/save_dash/{}/".format(dash.id)
    ...
    def test_copy_dash(self, username="admin"):
        ...
        dash_id = dash.id
        url = "/spotrix/save_dash/{}/".format(dash_id)
        ...
        url = "/spotrix/copy_dash/{}/".format(dash_id)
    ...
    def test_add_slices(self, username="admin"):
        ...
        url = "/spotrix/add_slices/{}/".format(dash.id)
    ...
    def test_public_user_dashboard_access(self):
        ...
        self.assertNotIn("/spotrix/dashboard/births/", resp)
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertIn("/spotrix/dashboard/births/", resp)
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertNotIn("/spotrix/dashboard/world_health/", resp)
    ...
    def test_dashboard_with_created_by_can_be_accessed_by_public_users(self):
        ...
        self.get_resp("/spotrix/dashboard/births/")
        # Cleanup
        self.revoke_public_access_to_table(table)
    ...
    def test_users_can_list_published_dashboard(self):
        self.login("alpha")
        resp = self.get_resp("/api/v1/dashboard/")
        assert f"/spotrix/dashboard/{pytest.hidden_dash_slug}/" not in resp
        assert f"/spotrix/dashboard/{pytest.published_dash_slug}/" in resp
    ...
    def test_users_can_view_own_dashboard(self):
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertIn(f"/spotrix/dashboard/{my_dash_slug}/", resp)
        self.assertNotIn(f"/spotrix/dashboard/{not_my_dash_slug}/", resp)
    ...
    def test_users_can_view_favorited_dashboards(self):
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertIn(f"/spotrix/dashboard/{fav_dash_slug}/", resp)
    ...
    def test_user_can_not_view_unpublished_dash(self):
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertNotIn(f"/spotrix/dashboard/{slug}/", resp)
