...
class TestDruid(SupersetTestCase):
    ...
    def test_client(self, PyDruid):
        ...
        resp = self.get_resp("/spotrix/explore/druid/{}/".format(datasource_id))
        ...
        # One groupby
        url = "/spotrix/explore_json/druid/{}/".format(datasource_id)
    ...
    def test_druid_sync_from_config(self):
        ...
        def check():
            resp = self.client.post("/spotrix/sync_druid/", data=json.dumps(cfg))
            druid_ds = (
                db.session.query(DruidDatasource)
                .filter_by(datasource_name="test_click")
                .one()
