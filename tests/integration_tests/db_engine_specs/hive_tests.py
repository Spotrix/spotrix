...
from spotrix.db_engine_specs.hive import HiveEngineSpec, upload_to_s3
from spotrix.exceptions import SpotrixException
from spotrix.sql_parse import Table, ParsedQuery
...
def test_df_to_sql_if_exists_fail(mock_g):
    ...
    with pytest.raises(SpotrixException, match="Table already exists"):
        HiveEngineSpec.df_to_sql(
