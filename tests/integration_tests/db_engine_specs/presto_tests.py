...
from spotrix.utils.core import DatasourceName, GenericDataType
    ...
    def test_extract_errors(self):
        ...
        assert result == [
            SpotrixError(
                ...
                error_type=SpotrixErrorType.COLUMN_DOES_NOT_EXIST_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            SpotrixError(
                ...
                error_type=SpotrixErrorType.SCHEMA_DOES_NOT_EXIST_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
