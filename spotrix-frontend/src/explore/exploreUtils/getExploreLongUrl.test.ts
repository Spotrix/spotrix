...
test('Get url when endpointType:standalone', () => {
  ...
  expect(
    ...
    '/spotrix/explore/?same=any-string&form_data=%7B%22datasource%22%3A%22datasource%22%2C%22viz_type%22%3A%22viz_type%22%7D',
  );
});
...
test('Get url when endpointType:results', () => {
  ...
  expect(
    ...
    '/spotrix/explore_json/?same=any-string&form_data=%7B%22datasource%22%3A%22datasource%22%2C%22viz_type%22%3A%22viz_type%22%7D',
  );
});
