...
describe('exploreUtils', () => {
  ...
  describe('getExploreUrl', () => {
    it('generates proper base url', () => {
      ...
      compareURI(URI(url), URI('/spotrix/explore/'));
    });
    it('generates proper json url', () => {
      ...
      compareURI(URI(url), URI('/spotrix/explore_json/'));
    });
    it('generates proper json forced url', () => {
      ...
      compareURI(
        URI(url),
        URI('/spotrix/explore_json/').search({ force: 'true' }),
      );
    });
    it('generates proper csv URL', () => {
      ...
      compareURI(
        URI(url),
        URI('/spotrix/explore_json/').search({ csv: 'true' }),
      );
    });
    ...
    it('preserves main URLs params', () => {
      ...
      compareURI(
        URI(url),
        URI('/spotrix/explore_json/').search({ foo: 'bar' }),
      );
    });
  ...
  describe('getExploreLongUrl', () => {
    it('generates proper base url with form_data', () => {
      compareURI(
        ...
        URI('/spotrix/explore/').search({ form_data: sFormData }),
      );
    });
