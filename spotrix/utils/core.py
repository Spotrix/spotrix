...
from spotrix.constants import (
    EXAMPLES_DB_UUID,
    EXTRA_FORM_DATA_APPEND_KEYS,
    EXTRA_FORM_DATA_OVERRIDE_EXTRA_KEYS,
    EXTRA_FORM_DATA_OVERRIDE_REGULAR_MAPPINGS,
)
from spotrix.errors import ErrorLevel, SpotrixErrorType
from spotrix.exceptions import (
    CertificateException,
    SpotrixException,
    SpotrixTimeoutException,
)
from spotrix.x_typing import AdhocMetric, FilterValues, FlaskResponse, FormData, Metric
from spotrix.utils.dates import datetime_to_epoch, EPOCH
from spotrix.utils.hashing import md5_sha_from_dict, md5_sha_from_str
...
if TYPE_CHECKING:
    from spotrix.connectors.base.models import BaseColumn, BaseDatasource
...
def validate_json(obj: Union[bytes, bytearray, str]) -> None:
    if obj:
        try:
            ...
            raise SpotrixException("JSON is not valid")
...
class SigalrmTimeout:
    ...
    def handle_timeout(  # pylint: disable=unused-argument
        ...
        raise SpotrixTimeoutException(
            error_type=SpotrixErrorType.BACKEND_TIMEOUT_ERROR,
