...
from spotrix import security_manager
from spotrix.models.helpers import (
    AuditMixinNullable,
    ExtraJSONMixin,
    ImportExportMixin,
)
from spotrix.models.tags import QueryUpdater
from spotrix.sql_parse import CtasMethod, ParsedQuery, Table
from spotrix.utils.core import QueryStatus, user_label
...
class SavedQuery(Model, AuditMixinNullable, ExtraJSONMixin, ImportExportMixin):
    ...
    def pop_tab_link(self) -> Markup:
        return Markup(
            f"""
            <a href="/spotrix/sqllab?savedQueryId={self.id}">
    ...
    def url(self) -> str:
        return "/spotrix/sqllab?savedQueryId={0}".format(self.id)
