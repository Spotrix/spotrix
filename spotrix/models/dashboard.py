...
from spotrix import app, ConnectorRegistry, db, is_feature_enabled, security_manager
from spotrix.connectors.base.models import BaseDatasource
from spotrix.connectors.druid.models import DruidColumn, DruidMetric
from spotrix.connectors.sqla.models import SqlMetric, TableColumn
from spotrix.extensions import cache_manager
from spotrix.models.helpers import AuditMixinNullable, ImportExportMixin
from spotrix.models.slice import Slice
from spotrix.models.tags import DashboardUpdater
...
from spotrix.utils.decorators import debounce
...
class Dashboard(  # pylint: disable=too-many-instance-attributes
    ...
    @property
    def url(self) -> str:
        return f"/spotrix/dashboard/{self.slug or self.id}/"
    ...
    def changed_by_url(self) -> str:
        if not self.changed_by:
            return ""
        return f"/spotrix/profile/{self.changed_by.username}"
