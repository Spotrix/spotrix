...
from spotrix import app, db_engine_specs, is_feature_enabled
from spotrix.db_engine_specs.base import TimeGrain
from spotrix.extensions import cache_manager, encrypted_field_factory, security_manager
from spotrix.models.helpers import AuditMixinNullable, ImportExportMixin
from spotrix.models.tags import FavStarUpdater
from spotrix.result_set import SpotrixResultSet
from spotrix.utils import cache as cache_util, core as utils
    ...
    def get_sqla_engine(
        ...
        if DB_CONNECTION_MUTATOR:
            if not source and request and request.referrer:
                if "/spotrix/dashboard/" in request.referrer:
                    source = utils.QuerySource.DASHBOARD
                elif "/spotrix/explore/" in request.referrer:
                    source = utils.QuerySource.CHART
                elif "/spotrix/sqllab/" in request.referrer:
