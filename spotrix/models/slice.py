...
from spotrix import ConnectorRegistry, db, is_feature_enabled, security_manager
from spotrix.legacy import update_time_range
from spotrix.models.helpers import AuditMixinNullable, ImportExportMixin
from spotrix.models.tags import ChartUpdater
...
from spotrix.viz import BaseViz, viz_types
...
class Slice(  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def explore_json_url(self) -> str:
        """Defines the url to access the slice"""
        return self.get_explore_url("/spotrix/explore_json")
    ...
    def changed_by_url(self) -> str:
        return f"/spotrix/profile/{self.changed_by.username}"  # type: ignore
    ...
    @property
    def url(self) -> str:
        return f"/spotrix/explore/?form_data=%7B%22slice_id%22%3A%20{self.id}%7D"
