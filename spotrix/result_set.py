...
# under the License.
""" Spotrix wrapper around pyarrow.Table.
"""
import datetime
import json
import logging
...
from spotrix import db_engine_specs
from spotrix.x_typing import DbapiDescription, DbapiResult
        ...
        if pa_data:  # pylint: disable=too-many-nested-blocks
            for i, column in enumerate(column_names):
                if pa.types.is_nested(pa_data[i].type):
                    ...
                    #  are added as a natively supported column type in Spotrix
                    #  (spotrix.utils.core.GenericDataType).
                    stringified_arr = stringify_values(array[column])
