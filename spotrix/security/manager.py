...
from spotrix import sql_parse
from spotrix.connectors.connector_registry import ConnectorRegistry
from spotrix.constants import RouteMethod
...
from spotrix.utils.core import DatasourceName, RowLevelSecurityFilterType

if TYPE_CHECKING:
    from spotrix.common.query_context import QueryContext
    from spotrix.connectors.base.models import BaseDatasource
    from spotrix.connectors.druid.models import DruidCluster
    ...
    from spotrix.sql_parse import Table
    from spotrix.viz import BaseViz

logger = logging.getLogger(__name__)


class SpotrixSecurityListWidget(ListWidget):
    """
...
UserModelView.list_widget = SpotrixSecurityListWidget
RoleModelView.list_widget = SpotrixRoleListWidget
PermissionViewModelView.list_widget = SpotrixSecurityListWidget
PermissionModelView.list_widget = SpotrixSecurityListWidget
...
class SpotrixSecurityManager(  # pylint: disable=too-many-public-methods
    SecurityManager
):
    ...
    SQLLAB_PERMISSION_VIEWS = {
        ...
        ("can_sqllab_viz", "Spotrix"),
        ("can_sqllab_table_viz", "Spotrix"),
        ("can_sqllab", "Spotrix"),
        ("menu_access", "SQL Lab"),
    ...
    def get_datasource_access_error_object(  # pylint: disable=invalid-name
        ...
        """
        return SpotrixError(
            error_type=SpotrixErrorType.DATASOURCE_SECURITY_ACCESS_ERROR,
    ...
    def get_table_access_error_object(self, tables: Set["Table"]) -> SpotrixError:
        """
        ...
        """
        return SpotrixError(
            error_type=SpotrixErrorType.TABLE_SECURITY_ACCESS_ERROR,
    ...
    def create_custom_permissions(self) -> None:
        ...
        self.add_permission_view_menu("can_share_dashboard", "Spotrix")
        self.add_permission_view_menu("can_share_chart", "Spotrix")
    ...
    def raise_for_access(
        ...
        if database and table or query:
            ...
            if denied:
                raise SpotrixSecurityException(
        ...
        if datasource or query_context or viz:
            ...
            from spotrix.extensions import feature_flag_manager
    ...
    def raise_for_dashboard_access(dashboard: "Dashboard") -> None:
        ...
        """
        from spotrix.dashboards.commands.exceptions import DashboardAccessDeniedError
        from spotrix.views.base import get_user_roles, is_user_admin
        from spotrix.views.utils import is_owner
        from spotrix import is_feature_enabled
    ...
    def can_access_based_on_dashboard(datasource: "BaseDatasource") -> bool:
        ...
        from spotrix.dashboards.filters import DashboardAccessFilter
