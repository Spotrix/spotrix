...
from spotrix.views.chart.mixin import SliceMixin
from spotrix.views.utils import bootstrap_user_data
...
class SliceModelView(
    ...
    def add(self) -> FlaskResponse:
        ...
        return self.render_template(
            "spotrix/add_slice.html", bootstrap_data=json.dumps(payload)
        )
