...
from spotrix.extensions import db, event_logger, security_manager
from spotrix.models.core import FavStar
from spotrix.models.dashboard import Dashboard
from spotrix.models.slice import Slice
from spotrix.schemas import error_payload_content
from spotrix.sql_lab import Query as SqllabQuery
from spotrix.stats_logger import BaseStatsLogger
from spotrix.x_typing import FlaskResponse
from spotrix.utils.core import time_function
...
def statsd_metrics(f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wraps(self: "BaseSpotrixModelRestApi", *args: Any, **kwargs: Any) -> Response:
        try:
...
class BaseSpotrixModelRestApi(ModelRestApi):
    """
    Extends FAB's ModelResApi to implement specific spotrix generic functionality
    """
