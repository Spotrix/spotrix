...
from spotrix.models.alerts import Alert, AlertLog, SQLObservation
from spotrix.tasks.alerts.validator import check_validator
from spotrix.x_typing import FlaskResponse
from spotrix.utils import core as utils
from spotrix.utils.core import get_email_address_str, markdown

from ..exceptions import SpotrixException
from .base import BaseSpotrixView, SupersetModelView
...
class BaseAlertReportView(BaseSpotrixView):
    route_base = "/report"
...
class AlertModelView(
    ...
    def pre_add(self, item: "AlertModelView") -> None:
        ...
        if not croniter.is_valid(item.crontab):
            raise SpotrixException("Invalid crontab format")
