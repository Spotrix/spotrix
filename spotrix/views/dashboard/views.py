...
from spotrix import db, event_logger, is_feature_enabled
from spotrix.constants import MODEL_VIEW_RW_METHOD_PERMISSION_MAP, RouteMethod
from spotrix.models.dashboard import Dashboard as DashboardModel
...
from spotrix.views.dashboard.mixin import DashboardMixin
...
class DashboardModelView(
    ...
    def download_dashboards(self) -> FlaskResponse:
        ...
        return self.render_template(
            "spotrix/export_dashboards.html", dashboards_url="/dashboard/list"
        )
...
class Dashboard(BaseSpotrixView):
    ...
    def new(self) -> FlaskResponse:  # pylint: disable=no-self-use
        ...
        db.session.commit()
        return redirect(f"/spotrix/dashboard/{new_dashboard.id}/?edit=true")
