...
import spotrix.models.core as models
from spotrix import app, dataframe, db, result_set, viz
...
from spotrix.legacy import update_time_range
...
from spotrix.x_typing import FormData
from spotrix.utils.core import QueryStatus, TimeRangeEndpoint
...
def get_datasource_info(
    ...
    :raises SpotrixException: If the datasource no longer exists
    """
    ...
    **kwargs: Any
    ...
    try:
        ...
        raise SpotrixSecurityException(
            SpotrixError(
                error_type=SpotrixErrorType.FAILED_FETCHING_DATASOURCE_INFO_ERROR,
    ...
    if datasource_type is None:
        raise SpotrixSecurityException(
            SpotrixError(
                error_type=SpotrixErrorType.UNKNOWN_DATASOURCE_TYPE_ERROR,
                level=ErrorLevel.ERROR,
...
def _deserialize_results_payload(
    ...
    if use_msgpack:
        ...
        df = result_set.SpotrixResultSet.convert_table_to_df(pa_table)
