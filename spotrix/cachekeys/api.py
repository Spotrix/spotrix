...
from spotrix.cachekeys.schemas import CacheInvalidationRequestSchema
from spotrix.connectors.connector_registry import ConnectorRegistry
from spotrix.extensions import cache_manager, db, event_logger
...
class CacheRestApi(BaseSpotrixModelRestApi):
