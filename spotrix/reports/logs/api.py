...
from spotrix.models.reports import ReportExecutionLog
from spotrix.reports.logs.schemas import openapi_spec_methods_override
from spotrix.views.base_api import BaseSpotrixModelRestApi

logger = logging.getLogger(__name__)


class ReportExecutionLogRestApi(BaseSpotrixModelRestApi):
