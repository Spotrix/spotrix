...
from spotrix import app, results_backend, results_backend_use_msgpack, security_manager
from spotrix.dataframe import df_to_records
from spotrix.db_engine_specs import BaseEngineSpec
from spotrix.errors import ErrorLevel, SpotrixError, SpotrixErrorType
from spotrix.exceptions import SpotrixErrorException, SpotrixCancelErrorsException
from spotrix.extensions import celery_app
from spotrix.models.core import Database
from spotrix.models.sql_lab import LimitingFactor, Query
from spotrix.result_set import SpotrixResultSet
from spotrix.sql_parse import CtasMethod, ParsedQuery
...
from spotrix.utils.decorators import stats_timing
...
def handle_query_error(
    ...
    if isinstance(ex, SpotrixErrorException):
        errors = [ex.error]
    elif isinstance(ex, SpotrixCancelErrorsException):
        errors = ex.errors
    else:
...
def execute_sql_statement(
    ...
    return SpotrixResultSet(data, cursor_description, db_engine_spec)
