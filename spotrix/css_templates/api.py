...
from spotrix.css_templates.commands.bulk_delete import BulkDeleteCssTemplateCommand
from spotrix.css_templates.commands.exceptions import (
    CssTemplateBulkDeleteFailedError,
    CssTemplateNotFoundError,
)
from spotrix.css_templates.filters import CssTemplateAllTextFilter
from spotrix.css_templates.schemas import (
    get_delete_ids_schema,
    openapi_spec_methods_override,
)
from spotrix.extensions import event_logger
from spotrix.models.core import CssTemplate
from spotrix.views.base_api import BaseSpotrixModelRestApi, statsd_metrics

logger = logging.getLogger(__name__)


class CssTemplateRestApi(BaseSpotrixModelRestApi):
