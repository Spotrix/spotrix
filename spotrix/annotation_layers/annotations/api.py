...
from spotrix.annotation_layers.annotations.commands.bulk_delete import (
    BulkDeleteAnnotationCommand,
)
from spotrix.annotation_layers.annotations.commands.create import (
    CreateAnnotationCommand,
)
from spotrix.annotation_layers.annotations.commands.delete import (
    DeleteAnnotationCommand,
)
from spotrix.annotation_layers.annotations.commands.exceptions import (
...
from spotrix.annotation_layers.annotations.commands.update import (
    UpdateAnnotationCommand,
)
from spotrix.annotation_layers.annotations.filters import AnnotationAllTextFilter
from spotrix.annotation_layers.annotations.schemas import (
    AnnotationPostSchema,
    AnnotationPutSchema,
    get_delete_ids_schema,
    openapi_spec_methods_override,
)
from spotrix.annotation_layers.commands.exceptions import AnnotationLayerNotFoundError
from spotrix.constants import MODEL_API_RW_METHOD_PERMISSION_MAP, RouteMethod
from spotrix.models.annotations import Annotation
from spotrix.views.base_api import BaseSpotrixModelRestApi, statsd_metrics

logger = logging.getLogger(__name__)


class AnnotationRestApi(BaseSpotrixModelRestApi):
