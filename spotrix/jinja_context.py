...
from spotrix.utils.core import convert_legacy_filters_into_adhoc, merge_extra_filters
...
class ExtraCache:
    ...
    def url_param(
        ...
        from spotrix.views.utils import get_form_data
    ...
    def get_filters(self, column: str, remove_filter: bool = False) -> List[Filter]:
        ...
        """
        from spotrix.utils.core import FilterOperator
        from spotrix.views.utils import get_form_data
