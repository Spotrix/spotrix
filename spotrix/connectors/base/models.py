...
from spotrix import is_feature_enabled, security_manager
...
from spotrix.x_typing import FilterValue, FilterValues, QueryObjectDict
...
class BaseDatasource(
    ...
    def explore_url(self) -> str:
        ...
        return f"/spotrix/explore/{self.type}/{self.id}/"
    ...
    def query(self, query_obj: QueryObjectDict) -> QueryResult:
        ...
        Should return a ``spotrix.models.helpers.QueryResult``
        """
        raise NotImplementedError()
