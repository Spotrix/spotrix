...
from spotrix.connectors.base.views import BS3TextFieldROWidget, DatasourceModelView
from spotrix.connectors.connector_registry import ConnectorRegistry
from spotrix.connectors.druid import models
...
class Druid(EnsureEnabledMixin, BaseSpotrixView):
