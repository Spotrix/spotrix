...
class HiveEngineSpec(PrestoEngineSpec):
    ...
    def patch(cls) -> None:
        ...
        from spotrix.db_engines import hive as patched_hive
    ...
    def df_to_sql(
        ...
        if to_sql_kwargs["if_exists"] == "append":
            raise SpotrixException("Append operation not currently supported")
        ...
        if to_sql_kwargs["if_exists"] == "fail":
            ...
            if table_exists:
                raise SpotrixException("Table already exists")
