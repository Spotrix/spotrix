...
from spotrix.db_engine_specs.base import BaseEngineSpec, BasicParametersMixin
...
if TYPE_CHECKING:
    from spotrix.models.core import Database  # pragma: no cover
...
class PostgresBaseEngineSpec(BaseEngineSpec):
    ...
    custom_errors: Dict[Pattern[str], Tuple[str, SpotrixErrorType, Dict[str, Any]]] = {
        CONNECTION_INVALID_USERNAME_REGEX: (
            ...
            SpotrixErrorType.CONNECTION_INVALID_USERNAME_ERROR,
            {"invalid": ["username"]},
        ),
        CONNECTION_INVALID_PASSWORD_REGEX: (
            __('The password provided for username "%(username)s" is incorrect.'),
            SpotrixErrorType.CONNECTION_INVALID_PASSWORD_ERROR,
...
class PostgresEngineSpec(PostgresBaseEngineSpec, BasicParametersMixin):
    ...
    def get_extra_params(database: "Database") -> Dict[str, Any]:
        ...
        :raises SpotrixException: If database extra json payload is unparseable
        """
        try:
            extra = json.loads(database.extra or "{}")
        except json.JSONDecodeError:
            raise SpotrixException("Unable to parse database extras")
