...
from spotrix import security_manager, sql_parse
from spotrix.errors import ErrorLevel, SpotrixError, SpotrixErrorType
from spotrix.models.sql_lab import Query
from spotrix.models.sql_types.base import literal_dttm_type_factory
from spotrix.sql_parse import ParsedQuery, Table
...
from spotrix.utils.network import is_hostname_valid, is_port_open

if TYPE_CHECKING:
    # prevent circular imports
    from spotrix.connectors.sqla.models import TableColumn
...
class BaseEngineSpec:  # pylint: disable=too-many-public-methods
    ...
    custom_errors: Dict[
        Pattern[str], Tuple[str, SpotrixErrorType, Dict[str, Any]]
    ] = {}
    ...
    def extract_errors(
        ...
        return [
            SpotrixError(
                error_type=SpotrixErrorType.GENERIC_DB_ENGINE_ERROR,
        ...
        try:
            ...
            errors.append(
                SpotrixError(
                    ...
                    error_type=SpotrixErrorType.CONNECTION_INVALID_PORT_ERROR,
                    level=ErrorLevel.ERROR,
                    extra={"invalid": ["port"]},
                ),
            )
        if not (isinstance(port, int) and 0 <= port < 2 ** 16):
            ...
            errors.append(
                SpotrixError(
                    ...
                    error_type=SpotrixErrorType.CONNECTION_PORT_CLOSED_ERROR,
                    level=ErrorLevel.ERROR,
                    extra={"invalid": ["port"]},
                ),
            )
